  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <div className="space-y-4 text-emerald-100/85 leading-relaxed">
        ...
        <p>
          We do not sell personal information. Data is stored securely and used only for service delivery and communication.
        </p>
        <p>
          If you need your data corrected or removed, contact us through the Contact page.
        </p>
      </div>
    </div>
  )
